...
export default async function FalconDetail({ params }: { params: Promise<{ id: string }> }) {
    ...
    const falconData: Record<string, { numeral: string, title: string, platform: string, caliber: string, mission: string, whySeries: string, buildDetails: string, options?: any, specDetails?: string, productImage?: string }> = {
        ...
        "iv": { numeral: "IV", title: "The Generalist", platform: "AR-15 (16\")", caliber: "5.56×45", mission: "- General Purpose Rifle (GPR)\n- Mid-range dominance\n- Multi-optic flexibility\n- Rural / mixed-terrain ops", whySeries: "Where the Duty Carbine excels up close, the Falcon IV owns the middle ground. With dual-optic capability, it transitions seamlessly from CQB to distance. This is the do-everything rifle every serious armory needs.\n\nEffective Range: 0–600 yards", buildDetails: "TBA" },
        "v": { numeral: "V", title: "The Shadow", platform: "AR-15", caliber: ".300 Blackout", mission: "- Suppressed operations\n- Low-signature engagements\n- CQB with enhanced terminal effect\n- Night operations", whySeries: "The Falcon V is built for discretion. Optimized for suppressed use, it delivers authority in close quarters while minimizing blast and signature. This is the rifle for working in the dark.\n\nEffective Range: 0–300 yards (mission-dependent)", buildDetails: "TBA" },
